...
pipeline = Pipeline('iqm_from_scores',[AverageScoreFusion()])

#Result base path:
result_path = 'result/iqm_from_scores'
...
dict_scores_prediction = { scores_database : {'AUE' :'scores/{}/iqm_scores_unconstrained'.format(scores_database),
                                              'ACE' : 'scores/{}/iqm_scores_constrained'.format(scores_database)
                                              }
                         }
