...
dict_scores_prediction = { scores_database : {'AUE' : 'scores/{}/gradiant_scores_unconstrained'.format(scores_database),
                                              'ACE' : 'scores/{}/gradiant_scores_constrained'.format(scores_database)
                                              }
                         }
